@arifnurdiansyah92/ckeditor5-audio-embed
========================================
...
The `@arifnurdiansyah92/ckeditor5-audio-embed` package is available under [MIT license](https://opensource.org/licenses/MIT).
